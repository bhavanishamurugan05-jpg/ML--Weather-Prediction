...
3. Create the Random Forest Classifier model and train it using the training data.
4. Predict the weather using the test data and calculate the model accuracy
...
## Output:
<img width="465" height="342" alt="image" src="https://github.com/user-attachments/assets/2fbb0fb7-a143-429b-9d3e-2bae6dae3095" />


## Result:


The Random Forest Algorithm model is successfully implemented for weather prediction, and the model predicts the weather conditions with good accuracy.
